...
Spec::Matchers.define :chop do |expected|
  match do |string|
          (@result = string.extend(Karate).))
        end
  end
                            end
end
